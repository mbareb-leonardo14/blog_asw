      ...
      <div className="mb-4 grid grid-cols-1 gap-4">
        <div className="">
          <input
            ...
            value="true"
          />
          <label className="text-gay-500 ml-2 cursor-pointer">
            Save my e-mail and name for the next I comment
          </label>
        </div>
      </div>
      {error && (
        <p className="text-ss text-red-500">All fields are required.</p>
      )}
      <div className="mt-8">
        <button
          type="button"
